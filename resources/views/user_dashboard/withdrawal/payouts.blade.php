        ...
        <div class="row">
            <div class="col-md-10 col-xs-12 mb20 marginTopPlus">
                ...
                <div class="right mb10">
                    <a href="{{url('/payout')}}" class="btn btn-cust ticket-btn"><i
                            class="fa fa-arrow-up"></i>&nbsp;@lang('message.dashboard.payout.new-payout.title')</a>
                </div>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="chart-list float-left">
                            <ul>
                                <li class="active"><a
                                        href="{{url('/payouts')}}">@lang('message.dashboard.payout.menu.payouts')</a>
                                </li>
                                <li><a
                                        href="{{url('/payout/setting')}}">@lang('message.dashboard.payout.menu.payout-setting')</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <table class="table recent_activity">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ ($payout->payment_method->name == "Mts") ? getCompanyName() : $payout->payment_method->name }}
                                    </td>

                                    <td>
                                        @if($payout->payment_method->name == "Bank")
                                        @if ($payout->withdrawal_detail)
                                        {{$payout->withdrawal_detail->account_name}}
                                        (*****{{substr($payout->withdrawal_detail->account_number,-4)}}
                                        )<br />
