        ...
        <div class="container">
            <div class="row">
                <div class="col-md-8 mb20 marginTopPlus">
                    ...
                    <div class="card">
                        <div class="card-header"><h4 class="float-left">@lang('message.dashboard.deposit.deposit-cardconnect-form.title')</h4></div>
                        <div class="card-body">
                            <form action="{{URL::to('deposit/cardconnect_payment_store')}}" method="post" id="payment-form">
